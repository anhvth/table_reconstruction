...
parser.add_argument('--input_dir', required=True, help='input to big size input')
parser.add_argument('--output_dir', required=True, help='output directory for training examples')
parser.add_argument('--strides', default=[30,30], help='output directory for training examples')
parser.add_argument('--ksize', default=[256,512], help='output directory for training examples')
